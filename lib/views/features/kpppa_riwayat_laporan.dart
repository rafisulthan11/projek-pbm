...
import 'package:flutter_perlinda/views/features/kpppa_detail_riwayat_laporan.dart';

class KPPPAReportList extends StatelessWidget {
  @override
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => KPPPADetailRiwayatLaporan(),
                            ),
                          );
                        },
